...
$(document).ready(function() {
	...
	$(".splash").css("background", "url(assets/media/images/hero-image-1.jpg) no-repeat top center");
	...
	window.setInterval(function() {
		...
		if(window.backgroundImage === 1) {
			...
			$(".splash").css("background", "url(assets/media/images/hero-image-2.jpg) no-repeat top center");
			$(".splash").css("background-size", "cover");
			window.backgroundImage = 2;

		} else if(window.backgroundImage === 2) {

			$(".splash").css("background", "url(assets/media/images/hero-image-3.jpg) no-repeat top center");
			$(".splash").css("background-size", "cover");
